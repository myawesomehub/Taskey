...
//        .frame(width: UIScreen.main.bounds.width / 1.9, height: UIScreen.main.bounds.height, alignment: .leading)
//        .padding(.leading , 40)
    ...
    var mainView: some View {
        ...
        .cornerRadius(30)
        .offset(x : showSide ? UIScreen.main.bounds.width / 1.5 : offsetX)
